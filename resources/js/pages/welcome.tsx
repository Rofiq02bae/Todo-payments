    ...
    return (
        <>
            ...
            <div className="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
                <div className="mb-4 flex w-full max-w-4xl justify-end gap-4">
                    {auth?.user ? (
                        <Link href="/todos" className="text-sm font-medium text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]">
                            Go to Todos
                        </Link>
                    ) : (
                        <>
                            <Link href="/login" className="text-sm font-medium text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]">
                                Login
                            </Link>
                            <Link href="/register" className="text-sm font-medium text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]">
                                Register
                            </Link>
                        </>
                    )}
